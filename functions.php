...
function load_fonts() {
  wp_register_style('et-googleFonts',
    'https://fonts.googleapis.com/css?family=Bangers|Roboto');
...
function load_jquery() {
  wp_enqueue_script('my-script', get_template_directory_uri() .'/js/contact-modal-toggle.js', array('jquery'));
}
...
function add_prism() {
  ...
  wp_register_style('prismCSS', get_stylesheet_directory_uri() . '/css/prism-skeletor.css');
